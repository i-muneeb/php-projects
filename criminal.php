...
<head>
    <meta charset="utf-8">
<title>Lawyer/criminal-lawyers</title>   
     ...
     <div class="container-fluid bg-page-header" style="margin-bottom: 90px; background-image: url(image/court.jpg);" >
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-4 text-white text-uppercase">Criminal Lawyers</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Criminal Lawyers</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center pb-2">
                <h6 class="text-uppercase">criminal Lawyers</h6>
                <h1 class="mb-4">Meet Our criminal Lawyers</h1>
            </div>
            <div class="row">
                <?php
               ...
               $sql = "SELECT * FROM criminal_lawyers";
               ...
               if (mysqli_num_rows($result)) {
                   ...
                   echo '<p>No divorce lawyers found.</p>';
               }
